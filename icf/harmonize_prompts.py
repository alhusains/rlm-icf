...
_HARMONIZE_SYSTEM = (
    ...
    "  • NEVER reword, paraphrase, or 'standardize' a [PLEASE COMPLETE] marker. It is a\n"
    "    literal placeholder the assembly step detects by exact text, not prose to polish --\n"
    "    copy it verbatim, character for character, in whichever sub-section it ends up in.\n"
    "    Do not invent alternative bracketed placeholders (e.g. '[TO BE FILLED MANUALLY]',\n"
    "    '[complete X]') under any circumstances; [PLEASE COMPLETE] is the only accepted form.\n"
