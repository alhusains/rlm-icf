...
REVIEW_SYSTEM_PROMPT = (
    ...
    "  3b. Never flag a [PLEASE COMPLETE] marker or an excerpt containing one. It is a "
    "literal placeholder for missing information, not prose with a plain-language problem -- "
    "leave it untouched no matter how awkward the surrounding sentence reads.\n"
