...
_HYBRID_DRAFT_SYSTEM_CORE = (
    ...
    "ONLY accepted placeholder string"
    "Do NOT invent a descriptive substitute that echoes the missing field's name (e.g. writing "
    "'[complete time]' or '[TO BE FILLED MANUALLY]' for an unfillable {{length of time}}). "
    "Example: if {{length of time}} and {{duration}} in 'The procedure will take about "
    "{{length of time}}. This will happen every {{frequency}} weeks for {{duration}} months.' "
    "are not stated in the findings, write exactly 'The procedure will take about [PLEASE "
    "COMPLETE]. This will happen every [PLEASE COMPLETE] weeks for [PLEASE COMPLETE] months.' "
    "-- never a paraphrased placeholder, and never omit the {{frequency}} you *can* fill just "
    "because a neighbouring placeholder in the same sentence is missing.\n"
