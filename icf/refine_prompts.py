...
def build_refinement_prompt(
    ...
    prompt += (
        ...
        "5. Use [PLEASE COMPLETE] only for genuinely absent information -- this exact string, "
        "even for a single placeholder mid-sentence. Never invent a descriptive substitute "
        "(e.g. '[complete time]').\n"
