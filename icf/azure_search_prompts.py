...
from icf.plain_language import STUDY_TEAM_NOTES_GUIDANCE
...
AZURE_SEARCH_SYSTEM_PROMPT = (
    ...
    "    write [PLEASE COMPLETE] or return status='NOT_FOUND'. [PLEASE COMPLETE] is the ONLY\n"
    "    accepted placeholder string, and it applies just as much to a single {{placeholder}}\n"
    "    buried inside an otherwise-complete sentence as to a whole missing section — never\n"
    "    invent a descriptive substitute that echoes the missing field's name (e.g.\n"
